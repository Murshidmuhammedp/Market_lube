    ...
    return (
        <footer className="bg-black text-center lg:text-left h-auto py-8">
            <div className="flex flex-col lg:flex-row items-center justify-between px-4 md:px-10">
                ...
                <div className="flex flex-col items-center lg:items-end text-white text-right pr-4 lg:pr-11">
                    <h1>
                        0474 65 74 98
                        <span className="block">info@bike-time.com</span>
                        <span>BE0803 024 891</span>
                    </h1>
                </div>
            </div>
        </footer>
