...
const Scrollbar = () => {
  ...
  return (
    <div className="flex bg-[#2e2e2e]">
      ...
      <div className="bg-black w-1/4 h-4/5 sticky top-8 flex flex-col justify-center items-center rounded-3xl border ml-8 mt-8">
      ...
      <div className="p-20 pl-48 w-3/4">
        {bikeDetails.map((bike, index) => (
          ...
          >
            <div className="w-full h-4/5 aspect-video overflow-hidden rounded-3xl relative mt-8">
              <img
                src={bike.image}
